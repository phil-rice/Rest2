...
public interface LinkDataToJson<J, Entity extends IXingYiResource, State> extends BiFunction<ContextForJson, Entity, List<J>> {
    static <J, Entity extends IXingYiResource, State> LinkDataToJson<J, Entity, State> fromLinkdata(
...
@ToString
@EqualsAndHashCode
class DefaultLinkDataToJson<J, Entity extends IXingYiResource, State> implements LinkDataToJson<J, Entity, State> {
