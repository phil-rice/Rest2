...
public interface Formating {
    ...
    static List<String> javaFile(Class<?> madeBy,String classOrInterface, PackageAndClassName packageAndClassName, String classPostFix, List<String> manualImports, Class<?>... imports) {
        return Lists.append(List.of("package " + packageAndClassName.packageName + ";", "//Made by " + madeBy.getName()),
