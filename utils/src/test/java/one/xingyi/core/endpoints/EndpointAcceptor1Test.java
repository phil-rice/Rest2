...
public class EndpointAcceptor1Test {
    ...
    EndpointAcceptor1<String> startEnd = EndpointAcceptor1.bookmarkAcceptor("get", "/some/{id}/atend", (sr,s)->sr.uri.getPath() + ".." + s);
    EndpointAcceptor1<String> start = EndpointAcceptor1.bookmarkAcceptor("get", "/some/{id}", (sr,s)->sr.uri.getPath() + ".." + s);
    EndpointAcceptor1<String> startWithHost = EndpointAcceptor1.bookmarkAcceptor("get", "{host}/some/{id}", (sr,s)->sr.uri.getPath() + ".." + s);
    EndpointAcceptor1<String> end = EndpointAcceptor1.bookmarkAcceptor("get", "{id}/end", (sr,s)->sr.uri.getPath() + ".." + s);
