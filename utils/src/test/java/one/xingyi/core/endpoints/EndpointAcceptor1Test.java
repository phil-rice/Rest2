...
public class EndpointAcceptor1Test {
    ...
    EndpointAcceptor1<String> startEnd = EndpointAcceptor1.bookmarkAcceptor("get", "/some/<id>/atend", Function.identity());
    EndpointAcceptor1<String> start = EndpointAcceptor1.bookmarkAcceptor("get", "/some/<id>", Function.identity());
    EndpointAcceptor1<String> end = EndpointAcceptor1.bookmarkAcceptor("get", "<id>/end", Function.identity());
